      ...
      <div className="bg-white rounded-[2rem] w-full max-w-sm p-8 shadow-xl animate-[fadeIn_0.2s_ease-out] max-h-[90vh] overflow-y-auto no-scrollbar">
        ...
        <div className="space-y-6 mb-8">
          ...
          <div className="space-y-3">
             <label className="block text-xs font-black text-gray-400 uppercase mb-1 mr-1">إدارة البيانات</label>
             <div className="grid grid-cols-2 gap-3">
                 ...
                 >
                    ...
                    <span className="text-[10px] font-black">نسخة احتياطية</span>
                 </button>
                 <button 
                 ...
                 >
                    ...
                    <span className="text-[10px] font-black">استعادة بيانات</span>
                 </button>
        ...
        <div className="space-y-3">
          ...
          <button 
              onClick={onClose}
              className="w-full bg-gray-100 text-gray-700 py-4 rounded-2xl font-black hover:bg-gray-200 transition-all active:scale-95 text-sm"
          >
              إغلاق
          </button>
        </div>
